...
// 一个更具建筑感和工程感的通用 Logo
export const CoreLogo = ({ size = 28, className }: IconProps) => (
...
export const MenuIcon = ({ isOpen, className }: { isOpen: boolean; className?: string }) => (
...
export const XLogo = ({ size = 20, className }: IconProps) => (
...
export const ExternalLink = ({ size = 12, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
